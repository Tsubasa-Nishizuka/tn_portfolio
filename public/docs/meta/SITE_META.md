# サイトの- **目的**: このサイトは、開発者Tsubasa Nishizukaの技術力を紹介し、最新のWeb技術を活用した実践的なアプリケーションを展示することで、潜在的なクライアントや雇用主にPRすることを目的としています。フルスタック開発のスキル、セキュリティの実装、AI統合などの高度な技術をデモンストレーションし、信頼性の高い開発パートナーを求める方々との出会いの場を提供します。また、AWS、Azure、Google Cloudなどの主要クラウドプラットフォームやFirebaseなどのサービス、CloudflareなどのCDN技術を活用した開発にも対応可能であることを示すことで、多様なインフラ環境での開発力をPRします。

## 基本情報
- **サイト名**: TN Portfolio
- **作者**: Tsubasa Nishizuka
- **説明**: 認証機能付きのポートフォリオサイト。複数ロール、DBアダプター、サーバーサイド認証を実装。
- **目的**: このサイトは、開発者Tsubasa Nishizukaの技術力を紹介し、最新のWeb技術を活用した実践的なアプリケーションを展示することで、潜在的なクライアントや雇用主にPRすることを目的としています。フルスタック開発のスキル、セキュリティの実装、AI統合などの高度な技術をデモンストレーションし、信頼性の高い開発パートナーを求める方々との出会いの場を提供します。また、AWS、Azure、Google Cloudなどの主要クラウドプラットフォームやFirebaseなどのサービス、CloudflareなどのCDN技術を活用した開発にも対応可能であることを示すことで、多様なインフラ環境での開発力をPRする目的で作られています。
